...
/**
 * SystemLogsService Service
 */
public class SystemLogsService extends BaseService {

  public SystemLogsService(@NonNull OkHttpClient httpClient, String serverUrl) {
   ...
   * @return response of {@code SystemLogList}
   */
  public SystemLogList getSystemLogs(
   ...
   * @param projectName String Your project name. This represents a collection of related SaladCloud resources. The project must be created before using the API.
   * @param containerGroupName String The unique container group name
   * @return response of {@code CompletableFuture<SystemLogList>}
   */
  public CompletableFuture<SystemLogList> getSystemLogsAsync(
    @NonNull String organizationName,
    @NonNull String projectName,
    @NonNull String containerGroupName
  ) throws ApiException, ValidationException {
