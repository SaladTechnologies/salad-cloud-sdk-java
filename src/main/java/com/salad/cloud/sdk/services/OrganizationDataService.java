...
public class OrganizationDataService extends BaseService {
   ...
   */
  public GpuClassesList listGpuClasses(@NonNull String organizationName) throws ApiException {
   ...
   * @return response of {@code GpuClassesList}
   */
  public CompletableFuture<GpuClassesList> listGpuClassesAsync(@NonNull String organizationName) throws ApiException {
    Request request = this.buildListGpuClassesRequest(organizationName);
  ...
  private Request buildListGpuClassesRequest(@NonNull String organizationName) {
