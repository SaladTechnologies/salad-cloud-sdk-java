...
public class UpdateContainerLogging {
  ...
  public static class UpdateContainerLoggingBuilder {

    private JsonNullable<AxiomLoggingConfiguration> axiom = JsonNullable.undefined();

    @JsonProperty("axiom")
    public UpdateContainerLoggingBuilder axiom(AxiomLoggingConfiguration value) {
      if (value == null) {
    ...
    @JsonProperty("datadog")
    public UpdateContainerLoggingBuilder datadog(DatadogLoggingConfiguration value) {
      if (value == null) {
    ...
    @JsonProperty("http")
    public UpdateContainerLoggingBuilder http(ContainerLoggingConfigurationHttp1 value) {
      if (value == null) {
    ...
    @JsonProperty("new_relic")
    public UpdateContainerLoggingBuilder newRelic(NewRelicLoggingConfiguration value) {
      if (value == null) {
    ...
    @JsonProperty("splunk")
    public UpdateContainerLoggingBuilder splunk(ContainerLoggingSplunkConfiguration value) {
      if (value == null) {
    ...
    @JsonProperty("tcp")
    public UpdateContainerLoggingBuilder tcp(TcpLoggingConfiguration value) {
      if (value == null) {
