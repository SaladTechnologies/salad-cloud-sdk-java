...
public class ListInferenceEndpointsParameters {
  ...
  public static class ListInferenceEndpointsParametersBuilder {

    private JsonNullable<Long> page = JsonNullable.undefined();

    @JsonProperty("page")
    public ListInferenceEndpointsParametersBuilder page(Long value) {
      if (value == null) {
    ...
    @JsonProperty("page_size")
    public ListInferenceEndpointsParametersBuilder pageSize(Long value) {
      if (value == null) {
