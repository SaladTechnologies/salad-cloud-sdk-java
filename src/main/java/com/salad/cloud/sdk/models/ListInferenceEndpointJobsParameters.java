...
public class ListInferenceEndpointJobsParameters {
  ...
  public static class ListInferenceEndpointJobsParametersBuilder {

    private JsonNullable<Long> page = JsonNullable.undefined();

    @JsonProperty("page")
    public ListInferenceEndpointJobsParametersBuilder page(Long value) {
      if (value == null) {
    ...
    @JsonProperty("page_size")
    public ListInferenceEndpointJobsParametersBuilder pageSize(Long value) {
      if (value == null) {
