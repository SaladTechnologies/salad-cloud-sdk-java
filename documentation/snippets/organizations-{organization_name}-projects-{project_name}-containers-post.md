...
public class Main {
    public static void main(String[] args) {
		...
		CreateContainerResourceRequirements createContainerResourceRequirements = CreateContainerResourceRequirements.builder()
			.cpu(827L)
			.gpuClasses(gpuClassesList)
			.memory(734164836L)
			.shmSize(64L)
			.storageAmount(761306530849177.9L)
			.build();
		...
		ContainerGroup response = saladCloudSdk.containerGroups.createContainerGroup("acme-corp", "dev-env", containerGroupCreationRequest);
